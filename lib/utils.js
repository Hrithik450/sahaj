...
import { COMPANION_PROMPTS, GOV_SERVICES } from "@/lib/features";
import { findUserByGoogleId, upsertGoogleUser } from "@/lib/db/users";
...
export async function extractTextFromImage(file, language = "en") {
  ...
  const langs = OCR_LANG_MAP[language] ?? OCR_LANG_MAP.en;
